...
namespace CodeAnalysis
{
    ...
    public interface IAction
    {
        ...
        void doActionInheritance(CSsemi.CSemiExp semi);
        void doActionAggregation(CSsemi.CSemiExp semi);
        void doActionComposition(CSsemi.CSemiExp semi);
        void doActionUsing(CSsemi.CSemiExp semi);
    }
    /////////////////////////////////////////////////////////
    ...
    public abstract class AAction : IAction
    {
        ...
        public abstract void doActionInheritance(CSsemi.CSemiExp semi);
        public abstract void doActionAggregation(CSsemi.CSemiExp semi);
        public abstract void doActionComposition(CSsemi.CSemiExp semi);
        public abstract void doActionUsing(CSsemi.CSemiExp semi);
    ...
    public abstract class ARule : IRule
    {
        ...
        public void doActionsInheritance(CSsemi.CSemiExp semi)
        {
            foreach (IAction action in actions)
                action.doActionInheritance(semi);
        }
        public void doActionsAggregation(CSsemi.CSemiExp semi)
        {
            foreach (IAction action in actions)
                action.doActionAggregation(semi);
        }
        public void doActionsComposition(CSsemi.CSemiExp semi)
        {
            foreach (IAction action in actions)
                action.doActionComposition(semi);
        }
        public void doActionsUsing(CSsemi.CSemiExp semi)
        {
            foreach (IAction action in actions)
                action.doActionUsing(semi);
        }
